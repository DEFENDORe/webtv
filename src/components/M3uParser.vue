<template>
  <v-card :disabled="progress !== null" :elevation="5">
    ...
    <v-card-text>
      ...
      <v-tabs-window v-model="mode">
        <v-tabs-window-item value="local">
          <v-file-input
            ...
            hint="Your IPTV M3U playlist file..."
            persistent-hint
            persistent-clear
        ...
        <v-tabs-window-item value="remote">
          <v-text-field
            ...
            hint="The url pointing to your m3u playlist"
            persistent-hint
            persistent-clear
            clearable
      ...
      <v-expand-transition>
        <v-progress-linear v-show="progress !== null" :indeterminate="!fileSize" :model-value="progress || 0" height="30" color="primary">
